...
# %%
# Prepare the labels to use them with tcc

value_encoder = ValueEncoder(label_encoder=encoder)
print(" value_encoder created")

# %%
# Train the tokenizer and inspect a sample
...
# %%
# Visualise word attributions for the top prediction
